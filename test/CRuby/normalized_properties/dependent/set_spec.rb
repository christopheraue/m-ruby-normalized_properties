describe NormalizedProperties::Dependent::Set do
  ...
  before do
    ...
    stub_const('DependentItem', Class.new do
      ...
      normalized_attribute :association, type: 'Dependent', model: 'ItemProperty',
      ...
      normalized_set :set, type: 'Dependent', model: 'ItemProperty',
        sources: {item: :set},
    ...
    context "when the set has a hash source" do
      before do
        class SetOwner
          ...
          normalized_attribute :child, type: 'Manual', model: 'SetOwner'
  ...
  describe "a set with model instances as items" do
    ...
    context "when the set consists of a subset of the set it depends on" do
      ...
      before do
        class SetOwner
          normalized_set :set_dependent, type: 'Dependent', model: 'DependentItem',
            sources: :set,
            sources_filter: ->(filter){ {set: filter} },
